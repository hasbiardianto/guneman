...
<div id="dismiss-toast"
    class="z-10 fixed bottom-0 start-0 hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-green-500 border border-gray-200 rounded-xl shadow-lg mx-3 my-4 min-w-[350px]"
    role="alert">
    <div class="flex p-4">
